    ...
    namespace
    {
        ...
        constexpr OrganicActionMetadataTable METADATA = { {
            ...
            { OrganicActionKind::TEMP_MONEY_TRICK, "TEMP_MONEY_TRICK", OrganicActionCategory::Wealth,
              "shared temporary-SetMoney boundary: RpgSubActions flight, WorldBuffTravelActions flight, MovementActions taxi/gold-cheat fare, buy/repair helpers (SetMoney runs MoneyChanged synchronously, which can permanently auto-reward money-required quests; restoring the balance cannot undo that)", OrganicClassification::Deny,
            ...
            { OrganicActionKind::DIRECT_AURA_REMOVAL, "DIRECT_AURA_REMOVAL", OrganicActionCategory::CharacterInit,
              "RemoveAuraAction ('ra' command): PlayerbotAI::RemoveAura on an arbitrary named aura", OrganicClassification::Deny,
